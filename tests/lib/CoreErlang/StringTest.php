...
class StringTest extends CoreErlangProgenitorTestCase
{
    public function testCreate()
    {
        ...
        $progenitor = new CoreErlang\String($file, $module, null, $progenitor_value);

        $obj_value = 'testin123'.uniqid();
        $obj    = new CoreErlang\String($file, $module, $progenitor, $obj_value);
    ...
    public function testGetAndSetValue()
    {
        ...
        $string = new CoreErlang\String($file, $module, null, $value1);
    ...
    public function testCompilePre()
    {
        list($file, $module) = $this->generateFileAndModule();
        $value1 = 'testin123'.uniqid();
        $obj = new CoreErlang\String($file, $module, null, $value1);
