...
class LitStringTest extends CoreErlangProgenitorTestCase
{
    public function testCreate()
    {
        ...
        $progenitor = CoreErlang\Lit::factoryString($file, $module, null, $progenitor_value);

        $value = 'testin123'.uniqid();
        $obj = CoreErlang\Lit::factoryString($file, $module, $progenitor, $value);
    ...
    public function testGetAndSetValue()
    {
        ...
        $string = CoreErlang\Lit::factoryString($file, $module, null, $value1);
    ...
    public function testCompilePre()
    {
        list($file, $module) = $this->generateFileAndModule();
        $value = 'testin123'.uniqid();
        $obj = CoreErlang\Lit::factoryString($file, $module, null, $value);
